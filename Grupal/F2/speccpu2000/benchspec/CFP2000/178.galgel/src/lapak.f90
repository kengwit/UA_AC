...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), TAU( * ), WORK( * )
...
*
*     .. Parameters ..
CLAB      DOUBLE PRECISION   ONE
      REAL*8   ONE
      PARAMETER          ( ONE = 1.0D+0 )
*     ..
*     .. Local Scalars ..
      INTEGER            I
CLAB      DOUBLE PRECISION   AII
      REAL*8   AII
*     ..
...
CLAB      DOUBLE PRECISION   ALPHA, BETA
      REAL*8   ALPHA, BETA
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), B( LDB, * ), C( LDC, * )
...
CLAB      DOUBLE PRECISION   TEMP
      REAL*8   TEMP
*     .. Parameters ..
CLAB      DOUBLE PRECISION   ONE         , ZERO
      REAL*8   ONE         , ZERO
...
CLAB      DOUBLE PRECISION   ALPHA, BETA
      ...
      CHARACTER*1        TRANS
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), X( * ), Y( * )
      REAL*8   A( LDA, * ), X( * ), Y( * )
*     ..
*
*  Purpose
...
*
*     .. Scalar Arguments ..
CLAB      DOUBLE PRECISION   LARGE, SMALL
      REAL*8   LARGE, SMALL
*     ..
*
*  Purpose
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), B( LDB, * )
      REAL*8   A( LDA, * ), B( LDB, * )
*     ..
*
*  Purpose
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   H( LDH, * ), WI( * ), WR( * ), Z( LDZ, * )
...
*
*     .. Parameters ..
CLAB      DOUBLE PRECISION   ZERO, ONE
      REAL*8   ZERO, ONE
      PARAMETER          ( ZERO = 0.0D+0, ONE = 1.0D+0 )
CLAB      DOUBLE PRECISION   DAT1, DAT2
      REAL*8   DAT1, DAT2
      PARAMETER          ( DAT1 = 0.75D+0, DAT2 = -0.4375D+0 )
*     ..
*     .. Local Scalars ..
      INTEGER            I, I1, I2, ITN, ITS, J, K, L, M, NH, NR, NZ
CLAB      DOUBLE PRECISION   CS, H00, H10, H11, H12, H21, H22, H33, H33S,
      REAL*8   CS, H00, H10, H11, H12, H21, H22, H33, H33S,
     $                   H43H34, H44, H44S, OVFL, S, SMLNUM, SN, SUM,
     $                   T1, T2, T3, TST1, ULP, UNFL, V1, V2, V3
*     ..
*     .. Local Arrays ..
CLAB      DOUBLE PRECISION   V( 3 ), WORK( 1 )
      REAL*8   V( 3 ), WORK( 1 )
*     ..
*     .. External Functions ..
CLAB      DOUBLE PRECISION   DLAMCH, DLANHS
      REAL*8   DLAMCH, DLANHS
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), T( LDT, NB ), TAU( NB ),
      REAL*8   A( LDA, * ), T( LDT, NB ), TAU( NB ),
     $                   Y( LDY, NB )
*     ..
*
*  Purpose
...
*
      END
CLAB      DOUBLE PRECISION FUNCTION DLAMCH( CMACH )
...
CLAB      DOUBLE PRECISION   BASE, EMAX, EMIN, EPS, PREC, RMACH, RMAX, RMIN,
...
*     .. Local Scalars ..
      ...
      INTEGER            LBETA, LT
CLAB      DOUBLE PRECISION   A, B, C, F, ONE, QTR, SAVEC, T1, T2
      REAL*8   A, B, C, F, ONE, QTR, SAVEC, T1, T2
*     ..
*     .. External Functions ..
CLAB      DOUBLE PRECISION   DLAMC3
      REAL*8   DLAMC3
      EXTERNAL           DLAMC3
*     ..
*     .. Save statement ..
...
CLAB      DOUBLE PRECISION   EPS, RMAX, RMIN
...
*     .. Local Scalars ..
     ...
     $                   NGNMIN, NGPMIN
CLAB      DOUBLE PRECISION   A, B, C, HALF, LEPS, LRMAX, LRMIN, ONE, RBASE,
...
************************************************************************
*
CLAB      DOUBLE PRECISION FUNCTION DLAMC3( A, B )
      FUNCTION DLAMC3( A, B )
      REAL*8 DLAMC3
*
*  -- LAPACK auxiliary routine (version 1.0) --
...
*     .. Executable Statements ..
*
      logical lSaveMe,lParanoid
      NameList /SaveMeFromTheDecOptimizer/ lSaveMe,lParanoid
      real*8 t
      logical lFirst
      save lFirst,lSaveMe,lParanoid
      data lFirst /.true./
      if(lFirst) then
         lSaveMe=.true.
         lParanoid=.false.
         read(5,nml=SaveMeFromTheDecOptimizer,end=999,err=999) 
  999    continue
         rewind(5)
         lFirst=.false.
      endif
...
*     .. Local Scalars ..
      INTEGER            I
CLAB      DOUBLE PRECISION   A, B1, B2, C1, C2, D1, D2, ONE, RBASE, ZERO
...
CLAB      DOUBLE PRECISION   OLDY, RECBAS, Y, Z
...
*
      END
CLAB      DOUBLE PRECISION FUNCTION DLANHS( NORM, N, A, LDA, WORK )
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), WORK( * )
      REAL*8   A( LDA, * ), WORK( * )
*     ..
*
*  Purpose
...
*     .. Local Scalars ..
      INTEGER            I, J
CLAB      DOUBLE PRECISION   SCALE, SUM, VALUE
...
*
      END
CLAB      DOUBLE PRECISION FUNCTION DLAPY2( X, Y )
      FUNCTION DLAPY2( X, Y )
      REAL*8 DLAPY2
*
*  -- LAPACK auxiliary routine (version 1.0) --
...
*     ..
*     .. Local Scalars ..
CLAB      DOUBLE PRECISION   W, XABS, YABS, Z
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   C( LDC, * ), T( LDT, * ), V( LDV, * ),
...
*     .. Scalar Arguments ..
      INTEGER            INCX, N
CLAB      DOUBLE PRECISION   ALPHA, TAU
      REAL*8   ALPHA, TAU
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   X( * )
      REAL*8   X( * )
*     ..
*
*  Purpose
...
*     .. Local Scalars ..
      INTEGER            J, KNT
CLAB      DOUBLE PRECISION   BETA, RSAFMN, SAFMIN, XNORM
      REAL*8   BETA, RSAFMN, SAFMIN, XNORM
*     ..
*     .. External Functions ..
CLAB      DOUBLE PRECISION   DLAMCH, DLAPY2, DNRM2
...
*     .. Scalar Arguments ..
      CHARACTER          SIDE
      INTEGER            LDC, M, N
CLAB      DOUBLE PRECISION   TAU
      REAL*8   TAU
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   C( LDC, * ), V( * ), WORK( * )
      REAL*8   C( LDC, * ), V( * ), WORK( * )
*     ..
*
*  Purpose
...
*     .. Local Scalars ..
      INTEGER            J
CLAB      DOUBLE PRECISION   SUM, T1, T10, T2, T3, T4, T5, T6, T7, T8, T9,
...
c     jack dongarra, linpack, 3/11/78.
c
CLAB      double precision dx(*),dy(*),dtemp
      real*8 dx(*),dy(*),dtemp
      integer i,incx,incy,ix,iy,m,mp1,n
c
      if(n.le.0)return
...
*
*     .. Scalar Arguments ..
CLAB      DOUBLE PRECISION   A, B, C, CS, D, RT1I, RT1R, RT2I, RT2R, SN
...
*
*     .. Parameters ..
CLAB      DOUBLE PRECISION   ZERO, HALF, ONE
      REAL*8   ZERO, HALF, ONE
      PARAMETER          ( ZERO = 0.0D+0, HALF = 0.5D+0, ONE = 1.0D+0 )
*     ..
*     .. Local Scalars ..
      INTEGER            INFO
CLAB      DOUBLE PRECISION   AA, BB, CC, CS1, DD, P, SAB, SAC, SIGMA, SN1,
      REAL*8   AA, BB, CC, CS1, DD, P, SAB, SAC, SIGMA, SN1,
     $                   TAU, TEMP
*     ..
*     .. External Functions ..
CLAB      DOUBLE PRECISION   DLAPY2
      REAL*8   DLAPY2
      EXTERNAL           DLAPY2
*     ..
*     .. Intrinsic Functions ..
...
*     .. Scalar Arguments ..
      INTEGER            INCX, N
CLAB      DOUBLE PRECISION   SCALE, SUMSQ
      REAL*8   SCALE, SUMSQ
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   X( * )
...
*
      END
CLAB      double precision function dnrm2 ( n, dx, incx)
      function dnrm2 ( n, dx, incx)
      real*8 dnrm2
      integer i, incx, ix, j, n, next
CLAB      double precision   dx(*), cutlo, cuthi, hitest, sum, xmax,zero,one
...
c     jack dongarra, linpack, 3/11/78.
c
CLAB      double precision dx(*),dy(*),dtemp,c,s
      real*8 dx(*),dy(*),dtemp,c,s
...
c     jack dongarra, linpack, 3/11/78.
c
CLAB      double precision dx(*),dy(*),da
      real*8 dx(*),dy(*),da
      integer i,incx,incy,ix,iy,m,mp1,n
c
      if(n.le.0)return
...
CLAB      double precision function ddot(n,dx,incx,dy,incy)
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   A( LDA, * ), SCALE( * )
      REAL*8   A( LDA, * ), SCALE( * )
*     ..
*
*  Purpose
*  =======
*
*  DGEBAL does permutations to isolate eigenvalues and/or balances a
*  real general matrix.  Balancing may reduce the 1-norm of the
...
CLAB      DOUBLE PRECISION   ZERO, ONE
      REAL*8   ZERO, ONE
      PARAMETER          ( ZERO = 0.0D+0, ONE = 1.0D+0 )
CLAB      DOUBLE PRECISION   SCLFAC, B2
      REAL*8   SCLFAC, B2
      PARAMETER          ( SCLFAC = 1.0D+1, B2 = SCLFAC*SCLFAC )
CLAB      DOUBLE PRECISION   FACTOR
      REAL*8   FACTOR
...
CLAB      DOUBLE PRECISION   C, F, G, R, S
      REAL*8   C, F, G, R, S
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*     ..
*     .. Local Arrays ..
CLAB      DOUBLE PRECISION   T( LDT, NBMAX )
      REAL*8   T( LDT, NBMAX )
*     ..
*     .. External Subroutines ..
...
*     ..
*     .. Array Arguments ..
CLAB      DOUBLE PRECISION   H( LDH, * ), WI( * ), WORK( * ), WR( * ),
      REAL*8   H( LDH, * ), WI( * ), WORK( * ), WR( * ),
     $                   Z( LDZ, * )
*     ..
*
*  Purpose
...
*
*     .. Parameters ..
CLAB      DOUBLE PRECISION   ZERO, ONE, TWO
      REAL*8   ZERO, ONE, TWO
      PARAMETER          ( ZERO = 0.0D+0, ONE = 1.0D+0, TWO = 2.0D+0 )
CLAB      DOUBLE PRECISION   CONST
      REAL*8   CONST
...
*     .. Local Scalars ..
     ...
     $                   MAXB, NH, NR, NS, NV
CLAB      DOUBLE PRECISION   ABSW, OVFL, SMLNUM, TAU, TEMP, TST1, ULP, UNFL
      REAL*8   ABSW, OVFL, SMLNUM, TAU, TEMP, TST1, ULP, UNFL
*     ..
*     .. Local Arrays ..
CLAB      DOUBLE PRECISION   S( LDS, NSMAX ), V( NSMAX+1 ), VV( NSMAX+1 )
      REAL*8   S( LDS, NSMAX ), V( NSMAX+1 ), VV( NSMAX+1 )
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            IDAMAX, ILAENV
CLAB      DOUBLE PRECISION   DLAMCH, DLANHS, DLAPY2
      REAL*8   DLAMCH, DLANHS, DLAPY2
...
CLAB      double precision function dnrsq ( n, dx, incx)
      function dnrsq ( n, dx, incx)
      real*8 dnrsq
      integer i, incx, ix, j, n, next
CLAB      double precision   dx(*)
      real*8   dx(*)
      real*8 dnrm2
      external dnrm2

          dnrsq = dnrm2(n, dx, incx)
...
*     .. Array Arguments ..
      INTEGER            IPIV( * )
CLAB      DOUBLE PRECISION   A( LDA, * ), WORK( LWORK )
      REAL*8   A( LDA, * ), WORK( LWORK )
*     ..
*
*  Purpose
*  =======
...
*
      END
CLAB      double complex function zdotu(n,zx,incx,zy,incy)
...
c
CLAB      double complex zx(*),zy(*),ztemp
...
CLAB      double precision function dznrm2( n, zx, incx)
      function dznrm2( n, zx, incx)
      real*8 dznrm2
      logical imag, scale
      integer i, incx, ix, n, next
CLAB      double precision cutlo, cuthi, hitest, sum, xmax, absx, zero, one
      real*8 cutlo, cuthi, hitest, sum, xmax, absx, zero, one
CLAB      double complex      zx(*)
      complex*16      zx(*)
CLAB      double precision dreal,dimag
      real*8 dreal,dimag
CLAB      double complex zdumr,zdumi
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA
CLAB
CLAB      COMPLEX*16         SpecCONJG
CLAB      EXTERNAL           SpecCONJG
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     .. Local Scalars ..
...
CLAB      double complex zx(*)
      complex*16 zx(*)
CLAB      double precision smax
      real*8 smax
      integer i,incx,ix,n
CLAB      double precision dcabs1
      real*8 dcabs1
c
      izamax = 0
      if(n.lt.1)return
...
CLAB      double precision function dcabs1(z)
      function dcabs1(z)
      real*8 dcabs1
CLAB      double complex z,zz
      complex*16 z,zz
CLAB      double precision t(2)
      real*8 t(2)
      equivalence (zz,t(1))
      zz = z
      ...
      function SpecCONJG(z)
      complex*16 SpecCONJG, z
      SpecCONJG = conjg(z)
      end

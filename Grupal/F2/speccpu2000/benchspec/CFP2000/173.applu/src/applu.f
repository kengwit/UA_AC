...
c      open (unit=5,file= 'applu.inp65',status='old',
c
...
c
      dimension phi1(iar,iar), phi2(iar,iar)
c
      do j = ji1, ji2
c     
         do i = ii1, ii2
...
c
         epsilon = 1.0d-08
c
c***Reference values of RMS-norms of residual, for the (51X51X51) grid,
c   after 250 time steps, with  DT = 2.0d+00
c
         xrr(1) = 716.74355320871d0
         xrr(2) = 59.660619521026d0
         xrr(3) = 179.33932533789d0
         xrr(4) = 164.10790502612d0
         xrr(5) = 1694.2303105812d0
c     
c***Reference values of RMS-norms of solution error, for the (51X51X51) grid,
c   after 250 time steps, with  DT = 2.0d+00
c
         xre(1) = 27.640733924798d0
         xre(2) = 2.6322983121916d0
         xre(3) = 6.7659132362238d0
         xre(4) = 6.1809215079778d0
         xre(5) = 65.212498930887d0
c
c***Reference value of surface integral, for the (51X51X51) grid,
c   after 250 time steps, with DT = 2.0d+00
c
         xri = 27.792630414454d0
c
c***verification test for residuals
c
         do m = 1, 5
...
c     
         write (6,1051)
 1051    format(//10x,'CAUTION',
     $ //5x,'REFERENCE VALUES CURRENTLY IN THIS VERIFICATION ',
     $     'ROUTINE ',
     $ /5x,'ARE VALID ONLY FOR RUNS WITH THE FOLLOWING PARAMETER ',
     $     'VALUES:',
     $ //5x,'NX = 51;  NY = 51;  NZ = 51 ',
     $ //5x,'ITMAX = 300',
     $ //5x,'DT = 1.5d-03',
     $ //5x,'OMEGA = 1.2',
     $ //5x,'CHANGE IN ANY OF THE ABOVE VALUES RENDER THE REFERENCE ',

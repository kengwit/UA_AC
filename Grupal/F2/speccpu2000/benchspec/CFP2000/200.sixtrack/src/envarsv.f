...
C  CAUTION:
C          A SPECIAL VERSION FOR VECTORIZATION - AUGUST   1994
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
      dimension ekv(npart,nele),fokqv(npart)
C     dimension nms(npart)
C     dimension bbiv(mmul,nmac,nblz),aaiv(mmul,nmac,nblz)
C     dimension xsiv(nmac,nblz)
C     dimension zsiv(nmac,nblz),smiv(nmac,nblz)
C     dimension zsv(npart)
C     dimension xsv(npart)
C     dimension qw(2)
C     dimension qwc(3)
C     dimension epsa(2)
C     dimension ekk(2),ci(mmul),cr(mmul),eps(2)
C     dimension ekkv(npart)
C     dimension xv(2,npart),yv(2,npart)
      dimension dpsv(npart)
C     dimension dp0v(npart),sigmv(npart)
C     dimension ejfv(npart)
C     dimension ejv(npart)
C     dimension cxzyv(npart)
C     dimension cxzv(npart)
C     dimension pstop(npart)
C     dimension x2dv(npart)
C     dimension x1dv(npart),xp1v(npart),xp2v(npart)
C     dimension zp1v(npart),zp2v(npart)
C     dimension z2dv(npart),z1dv(npart)
C     dimension cpv(npart)
C     dimension spv(npart),cxv(npart),sxv(npart)
C     dimension szv(npart)
C     dimension czv(npart)
C     dimension phixv(npart),phizv(npart)
C     dimension phipv(npart)
      dimension rvv(npart)
C     dimension numxv(npart),ejf0v(npart)
...
C     dimension xvl(2,npart)
C     dimension yvl(2,npart),ejvl(npart)
      dimension oidpsv(npart)
C     dimension dpsvl(npart)
C     dimension sigmvl(npart)
C     dimension iv(npart)
C     dimension ixv(npart),aperv(npart,2)
C     dimension alf0v(npart,2)
C     dimension ampv(npart),bet0v(npart,2)
C     dimension hv(6,2,npart,nblo)
C     dimension bl1v(6,2,npart,nblo)
C     dimension alf0s(npart,2)
C     dimension qwcs(npart,3)
C     dimension bet0s(npart,2),tas(npart,4,4)
C     dimension di0zs(npart)
C     dimension dip0xs(npart),di0xs(npart),dip0zs(npart)
      save
C-----------------------------------------------------------------------
      do 10 j=1,napx
        dpd(j)=one+dpsv(j)

...
**
*H  @(#)$Id: range.h,v 3.3 1993/02/04 10:51:10 martin Rel $
**
...
**  ranges.
*/
extern  TypHandle       ElmRange P((
            TypHandle           hdList,
            long                pos ));

extern  TypHandle       ElmfRange P((
            TypHandle           hdList,
            long                pos ));
...
*/
extern  TypHandle       EvMakeRange P((
            TypHandle           hdMake ));

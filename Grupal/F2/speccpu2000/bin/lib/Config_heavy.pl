...
## Configured by: alrahate@rahul-ht.amr.corp.intel.com
### Target system: WIN32 
...
cccdlflags=' '
ccdlflags=' '
ccflags='-nologo -Gf -W3 -MT -Zi -DNDEBUG -O1 -DWIN32 -D_CONSOLE -DNO_STRICT -DHAVE_DES_FCRYPT  -DPERL_IMPLICIT_CONTEXT -DPERL_IMPLICIT_SYS -DUSE_PERLIO -DPERL_MSVCRT_READFIX'
ccflags_uselargefiles=''
ccname='cl'
ccsymbols=''
ccversion='13.10.3077'
cf_by='alrahate'
cf_email='alrahate@rahul-ht.amr.corp.intel.com'
cf_time='Thu Sep  1 13:58:45 2005'
charsize='1'
chgrp=''
chmod=''
chown=''
...
incpath='"c:\Program Files\Microsoft Visual Studio .NET 2003\VC7\include"'
inews=''
installarchlib='c:\specperl\lib'
installbin='c:\specperl\bin'
installhtmldir='c:\specperl\html'
installhtmlhelpdir='c:\specperl\htmlhelp'
installman1dir='c:\specperl\man\man1'
installman3dir='c:\specperl\man\man3'
installprefix='c:\specperl'
installprefixexp='c:\specperl'
installprivlib='c:\specperl\lib'
installscript='c:\specperl\bin'
installsitearch='c:\specperl\site\lib'
installsitebin='c:\specperl\bin'
installsitelib='c:\specperl\site\lib'
installstyle='lib'
...
ksh=''
ld='link'
lddlflags='-dll -nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"c:\specperl\lib\CORE"  -machine:x86'
ldflags='-nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"c:\specperl\lib\CORE"  -machine:x86'
...
libs='  oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib  comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib  netapi32.lib uuid.lib ws2_32.lib mpr.lib winmm.lib  version.lib odbc32.lib odbccp32.lib libcmt.lib'
libsdirs=''
libsfiles=''
libsfound=''
libspath=''
...
mallocsrc='malloc.c'
malloctype='void *'
man1dir='c:\specperl\man\man1'
man1direxp='c:\specperl\man\man1'
man1ext='1'
man3dir='c:\specperl\man\man3'
man3direxp='c:\specperl\man\man3'
man3ext='3'
mips_type=''
mkdir='mkdir'
mmaptype='void *'
...
perl='perl'
perladmin=''
perllibs='  oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib  comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib  netapi32.lib uuid.lib ws2_32.lib mpr.lib winmm.lib  version.lib odbc32.lib odbccp32.lib libcmt.lib'
perlpath='c:\specperl\bin\perl.exe'
pg=''
phostname='hostname'
pidtype='int'
plibpth=''
...
pr=''
prefix='c:\specperl'
prefixexp='c:\specperl'
privlib='c:\specperl\lib'
...
sig_size='27'
signal_t='void'
sitearch='c:\specperl\site\lib'
sitearchexp='c:\specperl\site\lib'
sitebin='c:\specperl\site\bin'
sitebinexp='c:\specperl\site\bin'
sitelib='c:\specperl\site\lib'
sitelib_stem=''
sitelibexp='c:\specperl\site\lib'
siteprefix='c:\specperl\site'
siteprefixexp='c:\specperl\site'
sizesize='4'
sizetype='size_t'
sleep=''
smail=''
...
ccflags_nolargefiles='-nologo -Gf -W3 -MT -Zi -DNDEBUG -O1 -DWIN32 -D_CONSOLE -DNO_STRICT -DHAVE_DES_FCRYPT  -DPERL_IMPLICIT_CONTEXT -DPERL_IMPLICIT_SYS -DUSE_PERLIO -DPERL_MSVCRT_READFIX'
ldflags_nolargefiles='-nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"c:\specperl\lib\CORE"  -machine:x86'
libs_nolargefiles=''

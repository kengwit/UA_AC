...
!!
      CALL TOTAL_MASS_REPORT ( IO_UNIT%LELO )
!!
...
!!
      CALL TIME_STEP_SUMMARY ( IO_UNIT%LELO )
!!
...
!!
!! ENERGY BALANCE CALCULATION.
!! External Energy (ENG1): Contributions from the work of surface tractions,
!! sliding interface forces, and moving kinematic boundaries.
!!
!! Internal Energy (ENG2): Contributions from the work of stresses, artificial
!! bulk viscosity and anti-hourglass forces.
!!
      IF (SUBCYCLING) THEN
        DO N = 1,NUMRT
          IF (NODE(N)%On) THEN
...
!!
 ...
 440    FORMAT                                                                 &
     &    (                                                                    &
     &    ' ',I8,2X,3(1PE10.2),I6,1X,E10.2,1X,A30,E9.2,2E10.2,1X,0PF8.2        &
     &    )
!!
      RETURN
      END
...
!SPEC_CPU2000        CALL TOTAL_MASS_REPORT (IO_UNIT%LCRO)
        ...
        CALL TIME_STEP_SUMMARY (IO_UNIT%LCRO)
...
!!
 ...
 115    FORMAT                                                                 &
     &    (                                                                    &
     &    2X,I4,1X,9(1PE13.4),3X,I4                                            &
     &    )
 125    FORMAT                                                                 &
     &    (                                                                    &
     &    I9,6(1PE14.4),6X,I4,I5,1PE11.2,I6                                    &
     &    )
 135    FORMAT                                                                 &
     &    (                                                                    &
     &    I9,6(1PE14.4),6X,I4,I5,1PE11.2,I6                                    &
 ...
 155    FORMAT                                                                 &
     &    (                                                                    &
     &    I7,'/',I1,6(1PE14.4),6X,I4,I5,1PE11.2,I6                             &
     &    )
 165    FORMAT                                                                 &
     &    (                                                                    &
     &    I6,'/',I2,6(1PE14.4),6X,I4,I5,1PE11.2,I6                             &
     &    )
 175    FORMAT                                                                 &
     &    (                                                                    &
     &    I9,6(1PE14.4),6X,I4,I5,1PE11.2,I6                                    &
